...
<div class="panel panel-default">
    ...
    <div class="panel-heading">Unanswerred Discussions</div>
	...
	$Result = $_UnansweredBAO->getAllDiscussions();
		...
		for($i = 0; $i < sizeof($DiscussionList); $i++) {
		    ...
		    <?php echo $Discussion->getName(); ?></a></td>
			    <td><?php $id = $Discussion->getCategory();
			    	$Result2 = $_UnansweredBAO->getNameFromCatagoryID($id);
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
		...
		<table class="table table-bordered">
			...
			<tr><?php
				$Result = $_UnansweredBAO->getAllDiscussionCategorys();
